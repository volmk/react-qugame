const questionsOriginal = [
    ...
    },
    {
        ...
        'question': 'A guarantee to an exporter that the importer of his goods will pay immediately for the goods ' +
    ...
    {
        'question': 'When you enter a situation without a definite plan of action, you are said to be "playing ' +
            'it by" what?',
        'content': [
            'Fingertips',
            'Ear',
    ...
    },
    {
        ...
        'question': 'The escape velocity of a rocket fired from the earth towards the moon is the velocity ' +
...
export default questionsOriginal
